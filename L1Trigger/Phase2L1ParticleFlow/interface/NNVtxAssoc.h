...
static const nn_inputtype associationNetworkEtaBounds[127] = {0.0,
                                                              ...
                                                              2.4801587301587302,
                                                              2.5};
static const nn_inputtype associationNetworkZ0ResBins[128] = {
    127.0, 126.0, 126.0, 126.0, 125.0, 124.0, 123.0, 122.0, 120.0, 119.0, 117.0, 115.0, 114.0, 112.0, 110.0, 107.0,
    105.0, 103.0, 101.0, 98.0,  96.0,  94.0,  91.0,  89.0,  87.0,  85.0,  82.0,  80.0,  78.0,  76.0,  74.0,  72.0,
    70.0,  68.0,  66.0,  64.0,  62.0,  61.0,  59.0,  57.0,  56.0,  54.0,  53.0,  51.0,  50.0,  48.0,  47.0,  46.0,
    45.0,  43.0,  42.0,  41.0,  40.0,  39.0,  38.0,  37.0,  36.0,  35.0,  34.0,  33.0,  33.0,  32.0,  31.0,  30.0,
    30.0,  29.0,  28.0,  28.0,  27.0,  26.0,  26.0,  25.0,  24.0,  24.0,  23.0,  23.0,  22.0,  22.0,  21.0,  21.0,
    21.0,  20.0,  20.0,  19.0,  19.0,  18.0,  18.0,  18.0,  17.0,  17.0,  17.0,  16.0,  16.0,  16.0,  15.0,  15.0,
    15.0,  15.0,  14.0,  14.0,  14.0,  14.0,  13.0,  13.0,  13.0,  13.0,  12.0,  12.0,  12.0,  12.0,  12.0,  11.0,
    11.0,  11.0,  11.0,  11.0,  10.0,  10.0,  10.0,  10.0,  10.0,  10.0,  9.0,   9.0,   9.0,   9.0,   9.0,   0.0};
static const l1ct::z0_t associationNetworkZ0binning[3] = {-20.46912512, 20.46912512, 0.15991504};
...
public:
  ...
  void TTTrackNetworkSelector(const l1ct::PFRegionEmu& region,
                              const l1ct::TkObjEmu& t,
                              const l1ct::PVObjEmu& v,
                              l1ct::nn_assoc_t& score);

  l1ct::nn_assoc_t getAssociationThreshold() { return associationThreshold_; }

private:
  nn_inputtype fPt_;
  nn_inputtype fMVA_;
  nn_inputtype fResBin_;
  nn_inputtype fDz_;

  l1ct::nn_assoc_t associationThreshold_;
