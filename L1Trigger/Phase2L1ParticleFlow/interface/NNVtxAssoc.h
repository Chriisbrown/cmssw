...
struct AssociationObjEmu{
  l1ct::nn_assoc_t hwAssociationScore;
...
public:
  ...
  void TTTrackNetworkSelector(const l1ct::PFRegionEmu& region, const l1ct::TkObjEmu& t, const l1ct::PVObjEmu& v,l1ct::nn_assoc_t& score);
