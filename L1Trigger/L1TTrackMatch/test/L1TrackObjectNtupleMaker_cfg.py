...
options.register('Emulation',False,VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.bool,"Emulated Vertex")
...
if options.Emulation:
    vertexInputTag = cms.InputTag("VertexProducer", "l1verticesEmulation")
else:
    vertexInputTag = cms.InputTag("VertexProducer", process.VertexProducer.l1VertexCollectionName.value())
...
process.L1TrackNtuple = cms.EDAnalyzer('L1TrackObjectNtupleMaker',
        ...
        SaveVertexEmulation = cms.bool(options.Emulation),
        RecoVertexInputTag = vertexInputTag
)
